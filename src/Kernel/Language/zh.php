...
return [
    ...
    'logger_prefix_producer'        => "Producer   | %worker_name% | PID:%process_id% | %worker_id%号生产器进程",
    'logger_prefix_downloader'      => "Downloader | %worker_name% | PID:%process_id% | %worker_id%号下载器进程",
    'logger_prefix_parser'          => "Parser     | %worker_name% | PID:%process_id% | %worker_id%号解析器进程",
    'logger_prefix_server'          => "Server     | %worker_name% | PID:%process_id% | %worker_id%号服务器进程",

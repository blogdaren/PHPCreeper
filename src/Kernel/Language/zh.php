...
return [
    ...
    'downloader_cache_disabled'     => "配置校验: 检测到下载任务时缓存已被禁用, 请确认是否需要开启缓存开关...........", 
    'downloader_create_cache_failed'=> "权限校验: 检测到下载任务时缓存目录禁写, 请确认是否是否赋予了足够的写权限", 
    'downloader_read_from_cache'    => "下载任务: 检测到下载器正尝试从缓存读取已下载的源数据, 请确认要不要启用缓存功能",
    ...
    'parser_task_success'           => "解析源码：第%connection_id%号连接 - 任务源码解析成功 (%task_id%)",
    'parser_task_report'            => "收到反馈：第%connection_id%号连接 - 任务源码处理成功 (%task_id%)",
    ...
    'invalid_httpclient_object'     => "危险行为：检测到非法的 httpClient 对象, 要求务必实现 HttpClientInterface 接口",
    'invalid_queueclient_object'    => "危险行为：检测到非法的 queueClient 对象, 要求务必实现 BrokerInterface 接口",

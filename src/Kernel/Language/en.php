...
return [
    ...
    'downloader_cache_disabled'     => "Config Check: detect that the download cache id disabled, please verify whether to enable it or not.", 
    ...
    'downloader_read_from_cache'    => "Task Download: detect that the loader is trying to read the downloaded source data from the cache.", 
    ...
    'parser_task_success'           => "Parse SourceCode：the connection id is %connection_id%: parse the task source code successfully.",
    'parser_task_report'            => "Receive Feedback: the connection id is %connection_id%: process the task source code successfully.",
